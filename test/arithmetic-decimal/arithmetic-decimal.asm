; @test{ "name": "Arithmetic decimal instruction test" }               
...
; Instruction tested: ADC, SBC in decimal mode 	
...
*= 0x0000
    ...
    JSR TEST                    ;@expected{ "NEXT":"0x0200" }
    LDA ERROR                   ;@expected{ "A":"0x00" }
    BRK                         ;@halt
...
; Source:
; https://6502.org/tutorials/decimal_mode.html (visited on 10/06/2026)
